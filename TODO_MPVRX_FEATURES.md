...
| 2 | **Stats overlay** (FPS, drop frame, codec, network sparkline, battery) | Thấp | Debug/power-user feature, đọc từ MPV property |
| 3 | **SMB/FTP/WebDAV client** | Trung bình | Thêm vào phần network/library browsing |
