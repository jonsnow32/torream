...
import com.tv.apps.zippy.databinding.ActivityMainBinding
import com.tv.apps.zippy.datastore.Serializer
import com.tv.apps.zippy.model.PlaybackData.Companion.KEY_PLAYBACK_JSON_URI
import com.tv.apps.zippy.network.initClient
import com.tv.apps.zippy.ui.colorpicker.ColorPickerDialogListener
import com.tv.apps.zippy.ui.player.PlayBackResult
import com.tv.apps.zippy.ui.player.PlayerEventType
import com.tv.apps.zippy.ui.player.mpv.MPVUtils
import com.tv.apps.zippy.utils.AppUtils.isCastApiAvailable
import com.tv.apps.zippy.utils.CommonActivitty
import com.tv.apps.zippy.utils.CommonActivitty.activityResultEvent
import com.tv.apps.zippy.utils.CommonActivitty.getNextFocus
import com.tv.apps.zippy.utils.CommonActivitty.keyEventListener
import com.tv.apps.zippy.utils.CommonActivitty.onUserLeaveHint
...
import com.tv.apps.zippy.utils.CommonActivitty.updateLocale
import com.tv.apps.zippy.utils.Coroutines.ioSafe
import com.tv.apps.zippy.utils.GlobalEvent.onColorSelectedEvent
import com.tv.apps.zippy.utils.GlobalEvent.onDialogDismissedEvent
import com.tv.apps.zippy.utils.InAppUpdater.Companion.runAutoUpdate
import com.tv.apps.zippy.utils.UIHelper
import com.tv.apps.zippy.utils.UIHelper.getResourceColor
import com.tv.apps.zippy.utils.UIHelper.isLandscape
import com.tv.apps.zippy.utils.UIHelper.isNightMode
import com.tv.apps.zippy.utils.UIHelper.navigate
import com.tv.apps.zippy.utils.UIHelper.setDefaultFocus
import com.tv.apps.zippy.utils.Utils.USER_AGENT
import com.tv.apps.zippy.utils.Utils.logError
import com.tv.apps.zippy.utils.Utils.setActivityInstance
...
//    }
  ...
  fun handleAppIntent(intent: Intent?) {
    ...
    if (intent.action == "com.tv.apps.zippy.OPEN_DOWNLOADS") {
      try {
