...
import com.tv.apps.zippy.ui.feed.viewholders.AdViewHolder
import com.tv.apps.zippy.ui.feed.viewholders.AudioSmallViewHolder
import com.tv.apps.zippy.ui.feed.viewholders.AudioViewHolder
import com.tv.apps.zippy.ui.feed.viewholders.FolderSmallViewHolder
import com.tv.apps.zippy.ui.feed.viewholders.FolderViewHolder
import com.tv.apps.zippy.ui.feed.viewholders.HttpDownloadViewHolder
import com.tv.apps.zippy.ui.feed.viewholders.TorrentDownloadViewHolder
import com.tv.apps.zippy.ui.feed.viewholders.VideoSmallViewHolder
import com.tv.apps.zippy.ui.feed.viewholders.VideoViewHolder
import com.tv.apps.zippy.ui.feed.viewholders.PlaylistViewHolder
import com.tv.apps.zippy.ui.feed.viewholders.PlaylistSmallViewHolder
import com.tv.apps.zippy.ui.feed.viewholders.horizontal.HorizontalListViewHolder


class FeedAdapter(
  private val clickListener: FeedAction,
  private val adManager: AdManager? = null,
  private var filterConfig: com.tv.apps.zippy.ui.feed.FeedFilterConfig? = null,
  private val downloadRepository: DownloadRepository
) : PagingDataAdapter<FeedData, FeedViewHolder<*>>(DiffCallback), GridAdapter {

  private val viewPool = RecyclerView.RecycledViewPool()

  fun updateFilterConfig(config: com.tv.apps.zippy.ui.feed.FeedFilterConfig) {
    filterConfig = config
  }
