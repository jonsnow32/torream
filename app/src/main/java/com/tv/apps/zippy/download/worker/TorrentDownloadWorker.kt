...
import com.tv.apps.zippy.download.torrent.TorrentSessionManager
...
class TorrentDownloadWorker @AssistedInject constructor(
  ...
  private val mediaStore: com.tv.apps.zippy.media.dataSource.MediaStoreDataSource,
  ...
  private suspend fun scanRecursive(dir: com.tv.apps.zippy.utils.UnifiedFile) {
