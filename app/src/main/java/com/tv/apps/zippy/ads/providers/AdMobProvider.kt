package com.tv.apps.zippy.ads.providers
...
class AdMobProvider : AdProvider {
            ...
            val adLoader = AdLoader.Builder(context, NATIVE_AD_UNIT_ID) // Test native ad unit
                .forNativeAd { nativeAd ->
                    try {
                        ...
                        val binding = com.tv.apps.zippy.databinding.LayoutAdmobNativeAdBinding.inflate(
                            layoutInflater,
                            container,
                            false
                        )
    ...
    private fun populateNativeAdView(
        ...
        binding: com.tv.apps.zippy.databinding.LayoutAdmobNativeAdBinding
    ) {
