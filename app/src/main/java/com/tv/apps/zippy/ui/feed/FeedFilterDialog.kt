...
import com.tv.apps.zippy.databinding.BottomSheetFeedFilterBinding
import com.tv.apps.zippy.ui.dialog.DockingDialog
...
class FeedFilterDialog : DockingDialog() {
  ...
  private fun setupSortByTab() {
    val tab = binding.root.findViewById<TabLayout>(com.tv.apps.zippy.R.id.sortByTabLayout)
