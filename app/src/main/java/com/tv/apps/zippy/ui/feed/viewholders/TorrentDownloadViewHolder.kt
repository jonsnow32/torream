...
import com.tv.apps.zippy.databinding.ItemTorrentDownloadBinding
...
class TorrentDownloadViewHolder(
  ...
  private fun updateUI(
    ...
    val buttonState = when (status) {
      DownloadStatus.PAUSED -> com.tv.apps.zippy.ui.download.PieFetchButton.State.PAUSED
      DownloadStatus.DOWNLOADING -> com.tv.apps.zippy.ui.download.PieFetchButton.State.DOWNLOADING
      DownloadStatus.FINISHED, DownloadStatus.COMPLETED -> com.tv.apps.zippy.ui.download.PieFetchButton.State.COMPLETED
      DownloadStatus.FAILED -> com.tv.apps.zippy.ui.download.PieFetchButton.State.ERROR
      else -> com.tv.apps.zippy.ui.download.PieFetchButton.State.IDLE
    }
