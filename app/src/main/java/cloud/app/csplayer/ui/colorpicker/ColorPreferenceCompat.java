...
public class ColorPreferenceCompat extends Preference implements ColorPickerDialogListener {
  ...
  @cloud.app.csplayer.ui.colorpicker.ColorPickerDialog.DialogType private int dialogType;
  ...
  private void init(AttributeSet attrs) {
    ...
    dialogType = a.getInt(R.styleable.ColorPreference_cpv_dialogType, cloud.app.csplayer.ui.colorpicker.ColorPickerDialog.TYPE_PRESETS);
    ...
    if (presetsResId != 0) {
      ...
      presets = cloud.app.csplayer.ui.colorpicker.ColorPickerDialog.MATERIAL_COLORS;
    }
  ...
  @Override protected void onClick() {
    ...
    if (onShowDialogListener != null) {
      ...
      cloud.app.csplayer.ui.colorpicker.ColorPickerDialog dialog = cloud.app.csplayer.ui.colorpicker.ColorPickerDialog.newBuilder()
  ...
  @Override public void onAttached() {
    super.onAttached();
    if (showDialog) {
      cloud.app.csplayer.ui.colorpicker.ColorPickerDialog fragment =
          (cloud.app.csplayer.ui.colorpicker.ColorPickerDialog) getActivity().getSupportFragmentManager().findFragmentByTag(getFragmentTag());
      if (fragment != null) {
  ...
  /**
   * Get the colors that will be shown in the {@link cloud.app.csplayer.ui.colorpicker.ColorPickerDialog}.
   *
  ...
  /**
   * Set the colors shown in the {@link cloud.app.csplayer.ui.colorpicker.ColorPickerDialog}.
   *
  ...
  /**
   * The listener used for showing the {@link cloud.app.csplayer.ui.colorpicker.ColorPickerDialog}.
