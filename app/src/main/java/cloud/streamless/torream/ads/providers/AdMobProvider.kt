package cloud.streamless.torream.ads.providers
...
class AdMobProvider : AdProvider {
            ...
            val adLoader = AdLoader.Builder(context, NATIVE_AD_UNIT_ID) // Test native ad unit
                .forNativeAd { nativeAd ->
                    try {
                        ...
                        val binding = cloud.streamless.torream.databinding.LayoutAdmobNativeAdBinding.inflate(
                            layoutInflater,
                            container,
                            false
                        )
    ...
    private fun populateNativeAdView(
        ...
        binding: cloud.streamless.torream.databinding.LayoutAdmobNativeAdBinding
    ) {
