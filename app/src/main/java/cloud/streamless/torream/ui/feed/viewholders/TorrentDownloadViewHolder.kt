...
import cloud.streamless.torream.databinding.ItemTorrentDownloadBinding
...
class TorrentDownloadViewHolder(
  ...
  private fun updateUI(
    ...
    val buttonState = when (status) {
      DownloadStatus.PAUSED -> cloud.streamless.torream.ui.download.PieFetchButton.State.PAUSED
      DownloadStatus.DOWNLOADING -> cloud.streamless.torream.ui.download.PieFetchButton.State.DOWNLOADING
      DownloadStatus.FINISHED, DownloadStatus.COMPLETED -> cloud.streamless.torream.ui.download.PieFetchButton.State.COMPLETED
      DownloadStatus.FAILED -> cloud.streamless.torream.ui.download.PieFetchButton.State.ERROR
      else -> cloud.streamless.torream.ui.download.PieFetchButton.State.IDLE
    }
