...
import cloud.streamless.torream.databinding.DialogTorrentStreamProgressBinding
...
import cloud.streamless.torream.download.torrent.TorrentStreamServer
    ...
    try {
      ...
      if (magnetOrTorrentUri.endsWith(".torrent", ignoreCase = true)) {
        ...
        val match = all.firstOrNull { state ->
          state.task.type == cloud.streamless.torream.download.DownloadType.TORRENT &&
