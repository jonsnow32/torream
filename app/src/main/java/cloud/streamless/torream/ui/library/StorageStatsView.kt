...
import cloud.streamless.torream.databinding.ViewStorageStatsBinding
  ...
  fun updateStats(stats: StorageStatsHelper.StorageStats) {
    try {
      ...
      binding.storageUsedText.text = context.getString(
        cloud.streamless.torream.R.string.storage_label_format,
        context.getString(cloud.streamless.torream.R.string.storage_used),
        StorageStatsHelper.formatBytes(stats.usedBytes)
      )
      binding.storageAppText.text = context.getString(
        cloud.streamless.torream.R.string.storage_label_format,
        context.getString(cloud.streamless.torream.R.string.storage_app),
        StorageStatsHelper.formatBytes(stats.appBytes)
      )
      binding.storageFreeText.text = context.getString(
        cloud.streamless.torream.R.string.storage_label_format,
        context.getString(cloud.streamless.torream.R.string.storage_free),
