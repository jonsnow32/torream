...
import cloud.streamless.torream.databinding.ToastBinding
...
import cloud.streamless.torream.utils.UIHelper.toPx
  ...
  fun getStackTrace(): String {
    ...
    val relevantFrames = stackTrace
      .filterIndexed { index, element ->
        ...
        !(element.className == "cloud.streamless.torream.utils.Utils" && element.methodName == "getStackTrace")
      }
