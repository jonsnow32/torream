...
#include <jni.h>
#define jni_func_name(name) Java_cloud_streamless_torream_ui_player_mpv_MPVLib_##name
...
UTIL_EXTERN jclass java_Integer, java_Double, java_Boolean, java_Long, java_ArrayList, java_HashMap;
...
UTIL_EXTERN jmethodID java_Long_init, java_ArrayList_init, java_ArrayList_add, java_HashMap_init, java_HashMap_put;
